...
\begin{frame}
	\frametitle{AVISOS}
	\begin{enumerate}
	\item Visitem a página da disciplina (http://sites.google.com/a/cin.ufpe.br/ese) \vspace{0.2cm}
	\item Assinem a lista \vspace{0.2cm}
	\item Baixem os slides e os compilem \vspace{0.2cm}
	\item Registrem as equipes \vspace{0.2cm}
	\item Procurem informações sobre o OpenREDU \vspace{0.2cm}
...
%restrições de uso de forma colateral. É importante enfatizar que "outros programas"
%são OUTRAS OBRAS, cuja distribuição é independente. Se esse item se aplicasse 
%à mesma obra, ele proibiria licenças de copyleft, o que claramente não é a intenção.
